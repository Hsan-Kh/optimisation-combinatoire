    ...
    with col2:
        if st.button("🚀 LANCER LA SIMULATION", type="primary", use_container_width=True):
            ...
            if algorithme == "Recuit Simulé":
                ...
                params_dict['taux_refroidissement'] = taux_refroidissement
            elif algorithme == "Recherche Tabou":
                params_dict['taille_tabou'] = taille_tabou
            elif algorithme == "Algorithme Génétique":
                params_dict['taille_population'] = taille_population
                params_dict['taux_croisement'] = taux_croisement
                params_dict['taux_mutation'] = taux_mutation
                params_dict['selection'] = selection
                params_dict['croisement'] = croisement
                params_dict['mutation'] = mutation
